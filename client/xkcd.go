...
const (
	...
	// DefaultClientTimeout is time to wait before canclling the request
	DefaultClientTimeout time.Duraction = 30 * time.Second

	//LatestComic is the latest comic number accorrding to the xkcd API
